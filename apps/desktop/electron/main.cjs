...
async function applyUpdates(opts = {}) {
  ...
  try {
    ...
    emitUpdateProgress({
      stage: 'restart',
      message: 'Updating AgentOS — this window will close and the updater will open. Don’t reopen AgentOS yourself; it restarts automatically when the update finishes.',
      percent: 100
    })
