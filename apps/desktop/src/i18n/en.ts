...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting AgentOS…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting AgentOS.',
    ...
    native: {
      ...
      turnDoneTitle: 'AgentOS finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to AgentOS defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while AgentOS is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'AgentOS asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while AgentOS was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let AgentOS follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'AgentOS checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading AgentOS configuration...',
    ...
    gateway: {
      ...
      intro:
        'AgentOS starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running AgentOS backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private AgentOS backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote AgentOS backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'AgentOS will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · AgentOS ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. AgentOS runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure AgentOS desktop' },
    ...
    signOutSuccessMessage: 'Enterprise authorization was cleared. The desktop will return to the auth screen.',
    signOutFailed: 'Sign-out failed',
    days: count => `${count}d`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent AgentOS environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. AgentOS will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting AgentOS...',
    placeholderReconnecting: 'Reconnecting to AgentOS…',
    ...
    attachUrlDesc: 'AgentOS will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of AgentOS can’t update itself from inside the app.',
    ...
    applyingBody: 'The AgentOS updater will take over in its own window and reopen AgentOS when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. AgentOS reconnects automatically when it’s back.',
    applyingClose: 'AgentOS will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'AgentOS needs a one-time install',
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another AgentOS CLI or desktop instance is running. Stop any running AgentOS instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The AgentOS installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    preparingInstall: 'AgentOS is finishing install. This usually takes under a minute on first run.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run AgentOS',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point AgentOS at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — AgentOS connects automatically',
      loopback: 'Opens your browser to sign in — AgentOS connects automatically',
    ...
    authorizeThere: 'Authorize AgentOS there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize AgentOS there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. AgentOS will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'AgentOS is restarting...',
      askRestart: 'Ask AgentOS to restart the server',
      lookingRestart: taskId => `AgentOS is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'AgentOS is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `AgentOS finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'AgentOS could not restart the server.',
      stillWorking:
        'AgentOS is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'AgentOS is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'AgentOS gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). AgentOS won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'AgentOS needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'AgentOS needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart AgentOS to use Save Image.',
    restartToSaveImages: 'Restart AgentOS to save images',
