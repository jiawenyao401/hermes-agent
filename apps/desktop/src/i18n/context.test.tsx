...
describe('I18nProvider', () => {
  ...
  it('falls back to Simplified Chinese when config loading fails', async () => {
    const configClient: I18nConfigClient = {
  ...
  it('falls back to Simplified Chinese without overwriting unsupported configured languages', async () => {
    const configClient: I18nConfigClient = {
