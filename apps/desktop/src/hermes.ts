...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'AgentOS gateway connection closed',
      connectErrorMessage: 'Could not connect to AgentOS gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'AgentOS gateway is not connected',
